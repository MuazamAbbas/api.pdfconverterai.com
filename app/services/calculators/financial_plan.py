...
class FinancialPlanCalculator:
    def __init__(self, app):
        self.app = app
        logger.debug("Financial Plan Calculator initialized with preloaded distilbert sentiment model")

    async def calculate_financial_plan(self, principal: float, rate: float, years: int, market_sentiment: str) -> dict:
        """
